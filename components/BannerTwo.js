...
import bannerMoc from "../assets/img/banner/3674230.jpg";
          ...
          <Row className="align-items-center">
            <Col md={8} lg={6} xl={5}>
              <div className="banner-text-inner">
                <h1>Şəhərdaxili 4 AZN
                -dan başlayan qiymətlərlə </h1>
                <p>
                ölkədə ilk dəfə olaraq qeyri-adi kuryer xidmətlərini təqdim edir.
                ...
                <a href="mailto:kalantarlikamran2@gmail.com" className="btn">
                  Email yaz
                </a>
                <a href="tel:+9945505585016" className="btn">
                  Zəng et
                </a>
              </div>
            </Col>
